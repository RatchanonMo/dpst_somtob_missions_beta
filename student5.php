...
;text-decoration:none" data-bs-toggle="tooltip" data-bs-placement="bottom" title="ขณะนี้คุณมีหัวใจ <?php echo $heart ?> ดวง" href="">
    ...
    <div class="row">
      ...
      <div class="col-xl-9 col-md-9 ">
        ...
        <div class="container">
          <h2 align="">รายชื่อนักเรียน ม.5</h2>
          <hr>
          <div class="row">
            ...
            <?php while ($row = mysqli_fetch_array($query)) { ?>
              ...
              <div class="col-xl-4 col-md-6 mb-3">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 align="center" class="card-title">พี่ <?php echo $row['nick_name'] ?></h5>
                    <p align="center" class="card-text">
                      <?php echo $row['first_name'] . " " . $row['last_name'] ?>
                      <br>
                      เลขที่ <?php echo $row['number'] ?>
                    </p>
                    <p align="center" data-bs-toggle="tooltip" data-bs-placement="bottom" title="เหลือหัวใจ <?php echo $row['heart'] ?> ดวง"> <i class="fa fa-heart" style="color:#ffc107"></i> <?php echo $row['heart'] ?>
                    </p>
                  </div>
