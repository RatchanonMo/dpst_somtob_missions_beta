...
<body>
  ...
  <div class="container mt-5">
    ...
    <a href="<?php echo $_SESSION['facebook'] ?>" target="_blank" class="btn btn-outline-primary">
      <i class="fab fa-facebook-f  " style="color:#0d6efd"></i>
    </a>
    <a type="button" style="font-size:20px; margin-left:15px;color:#ffc107;text-decoration:none" 
    data-bs-toggle="tooltip" data-bs-placement="bottom" title="ขณะนี้คุณเหลือหัวใจ <?php echo $heart ?> ดวง" >
      <i class="fa fa-heart" style="color:#ffc107"></i> <?php echo $heart ?>
